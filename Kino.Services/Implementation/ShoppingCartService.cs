...
namespace Kino.Services.Implementation
{
    ...
    public class ShoppingCartService : IShoppingCartService
    {
        ...
        private readonly IRepository<KartaInOrder> _productInOrderRepository;
        private readonly IUserReopsitory _userRepository;
        public ShoppingCartService(IRepository<EmailMessage> mailRepository, IRepository<ShoppingCart> shoppingCartRepository,IUserReopsitory userRepository, IRepository<Order> orderRepository, IRepository<KartaInOrder> productInOrderRepository)
        {
        ...
        public bool Order(string userId)
        {
            ...
            List<KartaInOrder> productInOrders = new List<KartaInOrder>();
            var result = userShoppingCart.ProductInShoppingCarts.Select(e => new KartaInOrder
            {
                Id = Guid.NewGuid(),
